								...
								<div id="logo-leader-wrap" class="left relative">
									<div class="logo-leader-out">
										<div class="logo-left-wrap left relative">
											...
											<?php } else { ?>
												<a itemprop="url" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img itemprop="logo" src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-leader.png" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" /></a>
											<?php } ?>
					...
					<?php $mvp_logo_loc = get_option('mvp_logo_loc'); if($mvp_logo_loc == 'Wide below leaderboard') { ?>
						<div class="logo-wide-wrap left relative">
							<?php if(get_option('mvp_logo')) { ?>
								<a itemprop="url" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img itemprop="logo" src="<?php echo esc_url(get_option('mvp_logo')); ?>" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" /></a>
							<?php } else { ?>
								<a itemprop="url" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img itemprop="logo" src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-large.png" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" /></a>
							<?php } ?>
							<?php if ( is_home() || is_front_page() ) { ?>
								<h1 class="mvp-logo-title"><?php bloginfo( 'name' ); ?></h1>
							<?php } else { ?>
				...
				<div class="col-tabs-wrap left relative">
					<ul class="col-tabs">
						<li class="feat-col-tab">
							<a href="#tab-col1"><?php _e( 'Destacado', 'mvp-text' ); ?></a>
						</li>
						<li class="latest-col-tab non-feat-tab">
							<a href="#tab-col2"><?php _e( 'Últimos Posts', 'mvp-text' ); ?></a>
						</li>
