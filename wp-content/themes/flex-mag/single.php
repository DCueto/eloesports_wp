						...
						<?php } ?>
										<?php $socialbox = get_option('mvp_social_box'); if ($socialbox == "true") { ?>
											<section class="social-sharing-top">
												<a href="#" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&amp;t=<?php the_title(); ?>', 'facebookShare', 'width=626,height=436'); return false;" title="<?php _e( 'Comparte en Facebook', 'mvp-text' ); ?>"><div class="facebook-share"><span class="fb-but1"><i class="fa fa-facebook fa-2"></i></span><span class="social-text"><?php _e( 'Compartir', 'mvp-text' ); ?></span></div></a>
												<a href="#" onclick="window.open('http://twitter.com/share?text=<?php the_title(); ?> -&amp;url=<?php the_permalink() ?>', 'twitterShare', 'width=626,height=436'); return false;" title="<?php _e( 'Twitea este post', 'mvp-text' ); ?>"><div class="twitter-share"><span class="twitter-but1"><i class="fa fa-twitter fa-2"></i></span><span class="social-text"><?php _e( 'Tweet', 'mvp-text' ); ?></span></div></a>
												<a href="whatsapp://send?text=<?php the_title(); ?> <?php the_permalink() ?>"><div class="whatsapp-share"><span class="whatsapp-but1"><i class="fa fa-whatsapp fa-2"></i></span><span class="social-text"><?php _e( 'Comparte', 'mvp-text' ); ?></span></div></a>
												<a href="#" onclick="window.open('http://pinterest.com/pin/create/button/?url=<?php the_permalink();?>&amp;media=<?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'mvp-post-thumb' ); echo $thumb['0']; ?>&amp;description=<?php the_title(); ?>', 'pinterestShare', 'width=750,height=350'); return false;" title="<?php _e( 'Pinguea este post', 'mvp-text' ); ?>"><div class="pinterest-share"><span class="pinterest-but1"><i class="fa fa-pinterest-p fa-2"></i></span><span class="social-text"><?php _e( 'Compartir', 'mvp-text' ); ?></span></div></a>
												<a href="mailto:?subject=<?php the_title(); ?>&amp;BODY=<?php _e( 'He encontrado este articulo interesante y he pensado que te puede gustar. Revísalo:', 'mvp-text' ); ?> <?php the_permalink(); ?>"><div class="email-share"><span class="email-but"><i class="fa fa-envelope fa-2"></i></span><span class="social-text"><?php _e( 'Email', 'mvp-text' ); ?></span></div></a>
												<?php if ( ! is_singular( 'scoreboard' )) { ?>
													...
													<?php } } else { ?>
														<?php $mvp_click_id = get_the_ID(); ?>
														<a href="<?php comments_link(); ?>"><div class="social-comments comment-click-<?php echo esc_html($mvp_click_id); ?>"><i class="fa fa-commenting fa-2"></i><span class="social-text-com"><?php _e('Comentarios', 'mvp-text'); ?></span></div></a>
													<?php } ?>
												<?php } ?>
										...
										<?php if ( ! is_singular( 'scoreboard' )) { ?>
											<div class="post-tags">
												<span class="post-tags-header"><?php _e( 'Relacionado:', 'mvp-text' ); ?></span><span itemprop="keywords"><?php the_tags('',', ','') ?></span>
											</div><!--post-tags-->
										<?php } ?>
										<?php $socialbox = get_option('mvp_social_box'); if ($socialbox == "true") { ?>
											<div class="social-sharing-bot">
												<a href="#" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&amp;t=<?php the_title(); ?>', 'facebookShare', 'width=626,height=436'); return false;" title="<?php _e( 'Comparte en Facebook', 'mvp-text' ); ?>"><div class="facebook-share"><span class="fb-but1"><i class="fa fa-facebook fa-2"></i></span><span class="social-text"><?php _e( 'Compartir', 'mvp-text' ); ?></span></div></a>
												<a href="#" onclick="window.open('http://twitter.com/share?text=<?php the_title(); ?> -&amp;url=<?php the_permalink() ?>', 'twitterShare', 'width=626,height=436'); return false;" title="<?php _e( 'Twitea este Post', 'mvp-text' ); ?>"><div class="twitter-share"><span class="twitter-but1"><i class="fa fa-twitter fa-2"></i></span><span class="social-text"><?php _e( 'Tweet', 'mvp-text' ); ?></span></div></a>
												<a href="whatsapp://send?text=<?php the_title(); ?> <?php the_permalink() ?>"><div class="whatsapp-share"><span class="whatsapp-but1"><i class="fa fa-whatsapp fa-2"></i></span><span class="social-text"><?php _e( 'Compartir', 'mvp-text' ); ?></span></div></a>
												<a href="#" onclick="window.open('http://pinterest.com/pin/create/button/?url=<?php the_permalink();?>&amp;media=<?php $thumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'mvp-post-thumb' ); echo $thumb['0']; ?>&amp;description=<?php the_title(); ?>', 'pinterestShare', 'width=750,height=350'); return false;" title="<?php _e( 'Pinguea este post', 'mvp-text' ); ?>"><div class="pinterest-share"><span class="pinterest-but1"><i class="fa fa-pinterest-p fa-2"></i></span><span class="social-text"><?php _e( 'Compartir', 'mvp-text' ); ?></span></div></a>
												<a href="mailto:?subject=<?php the_title(); ?>&amp;BODY=<?php _e( 'He encontrado este articulo interesante y he pensado que te podría gustar: Revísalo:', 'mvp-text' ); ?> <?php the_permalink(); ?>"><div class="email-share"><span class="email-but"><i class="fa fa-envelope fa-2"></i></span><span class="social-text"><?php _e( 'Email', 'mvp-text' ); ?></span></div></a>
										...
										<?php if ( comments_open() ) { ?>
											<?php $disqus_id = get_option('mvp_disqus_id'); if ($disqus_id) { if (isset($disqus_id)) {  ?>
												...
												<div id="comments-button" class="left relative comment-click-<?php echo esc_html($mvp_click_id); ?> com-but-<?php echo esc_html($mvp_click_id); ?>">
													<span class="comment-but-text"><?php comments_number(__( 'Comentarios', 'mvp-text'), __('Comentarios', 'mvp-text'), __('Comentarios', 'mvp-text')); ?></span>
												</div><!--comments-button-->
												<?php $disqus_id2 = esc_html($disqus_id); mvp_disqus_embed($disqus_id2); ?>
											<?php } } else { ?>
												<?php $mvp_click_id = get_the_ID(); ?>
												<div id="comments-button" class="left relative comment-click-<?php echo esc_html($mvp_click_id); ?> com-but-<?php echo esc_html($mvp_click_id); ?>">
													<span class="comment-but-text"><?php comments_number(__( 'Clickea para comentar', 'mvp-text'), __('1 Comentario', 'mvp-text'), __('% Comentarios', 'mvp-text'));?></span>
												</div><!--comments-button-->
